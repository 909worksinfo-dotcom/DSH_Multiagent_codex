...
const LINK_MAP: Record<string, string> = {
  ...
  CollaborationEventId: 'agent-team.md',
  ...
  TeamRunCreatedEventData: 'agent-team.md',
  TeamRunMemberEventData: 'agent-team.md',
  TeamRunMessageEventData: 'agent-team.md',
  TeamRunPhaseEventData: 'agent-team.md',
  TeamRunTaskEventData: 'agent-team.md',
