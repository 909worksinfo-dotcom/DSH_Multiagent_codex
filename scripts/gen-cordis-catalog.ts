...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  expertCatalog: 'agent-team.md',
  expertRuntime: 'agent-team.md',
  teamOrchestrator: 'agent-team.md',
  teamRuns: 'agent-team.md',
...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  collaboration: 'client-side interface-typed browser service — packages/client/runtime/README.md owns the API',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  SkillMarketplaceSearchResult: 'skills.md',
  ...
  BeginExpertProvisionRequest: 'agent-team.md',
  CancelTeamOrchestrationRequest: 'agent-team.md',
  ChangeTeamRunPhaseRequest: 'agent-team.md',
  CollaborationMessageId: 'agent-team.md',
  CreateTeamRunRequest: 'agent-team.md',
  CreateTeamOrchestrationRequest: 'agent-team.md',
  CreateTeamTaskRequest: 'agent-team.md',
  ExpertBindingEventData: 'agent-team.md',
  ExpertBlueprint: 'agent-team.md',
  ExpertBlueprintRef: 'agent-team.md',
  ExpertProvisionAttemptId: 'agent-team.md',
  FailExpertProvisionRequest: 'agent-team.md',
  MaterializeTeamProtocolRequest: 'agent-team.md',
  ProvisionedExpert: 'agent-team.md',
  ProvisionExpertRequest: 'agent-team.md',
  ProvisionAttemptId: 'agent-team.md',
  PublicCollaborationMessage: 'agent-team.md',
  PublishCollaborationMessageRequest: 'agent-team.md',
  RecoveredExpert: 'agent-team.md',
  ResolvedExpertBinding: 'agent-team.md',
  ResolveExpertBindingOptions: 'agent-team.md',
  ...
  SucceedExpertProvisionRequest: 'agent-team.md',
  TeamId: 'agent-team.md',
  TeamArtifactRecord: 'agent-team.md',
  WriteTeamArtifactRequest: 'agent-team.md',
  TeamDecisionRecord: 'agent-team.md',
  WriteTeamDecisionRequest: 'agent-team.md',
  CreateTeamQualityGateRequest: 'agent-team.md',
  TeamQualityGateRecord: 'agent-team.md',
  UpdateTeamQualityGateRequest: 'agent-team.md',
  TeamControlRequest: 'agent-team.md',
  CompleteTeamRunRequest: 'agent-team.md',
  TeamMemberSnapshot: 'agent-team.md',
  TeamMemberView: 'agent-team.md',
  TeamMembership: 'agent-team.md',
  TeamOrchestrationCommand: 'agent-team.md',
  TeamOrchestrationSnapshot: 'agent-team.md',
  TeamRunId: 'agent-team.md',
  TeamRunSnapshot: 'agent-team.md',
  ReplaceTeamExpertRequest: 'agent-team.md',
  TeamTaskId: 'agent-team.md',
  TeamTaskView: 'agent-team.md',
  TerminateTeamRunRequest: 'agent-team.md',
