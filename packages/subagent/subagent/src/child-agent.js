 ...
 */
export function childSessionMeta(parent, childDepth, lineageSeedLength, explicitAgentPreset) {
 ...
 */
export async function applyChildComposition(childCtx, parent, composition) {
    if (composition.agentPreset === undefined) {
        ...
        if (presets === undefined) {
            throw new Error(`subagent preset "${composition.agentPreset}" cannot be mounted because agentPresets is unavailable`);
        }
