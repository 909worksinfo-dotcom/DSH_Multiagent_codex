 ...
 */
export declare function childSessionMeta(parent: Agent, childDepth: number, lineageSeedLength: number, explicitAgentPreset?: string): NonNullable<CreateAgentOptions['meta']>;
 ...
 */
export declare function applyChildComposition(childCtx: Context, parent: Agent, composition: ChildComposition): Promise<void>;
