...
export interface CollaborationTaskProfile {
  /** Host-classified task domain; absent only on legacy snapshots. */
...
/** One immutable task shown for confirmation before its expert is provisioned. */
...
/** Provider/model options shared with the everyday-session selector. */
...
/** Model-invocable local skill offered for review-time expert configuration. */
...
/** Value-free external capability credential readiness. */
