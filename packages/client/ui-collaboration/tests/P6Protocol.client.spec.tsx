...
describe('P6 authoritative collaboration protocol', () => {
  it('renders enforced topology, capability, budget, and challenge state from run.protocol only', () => {
    ...
    expect(container.querySelector('[data-protocol-summary]')).toBeTruthy()
    expect(container.querySelectorAll('[data-protocol-rule]')).toHaveLength(3)
    expect(container.querySelector('[data-protocol-budget]')).toBeTruthy()
    expect(container.querySelector('[data-protocol-members]')).toBeTruthy()
    expect(container.querySelector('[data-protocol-challenges]')).toBeTruthy()
    expect(container.querySelectorAll('[data-protocol-topology]')).toHaveLength(1)
