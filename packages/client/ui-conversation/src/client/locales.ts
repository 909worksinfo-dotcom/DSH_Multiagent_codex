...
export const zh = {
  ...
  'approval.reject': '拒绝',
  'approval.allowForTask': '本任务运行',
  'approval.allowOnce': '允许一次',
  'turnSummary.label': '本任务执行了',
  'ask.rowTitle': '提问',
  'ask.waiting': '等待回答',
  'ask.cancelled': '已取消',
  'ask.interrupted': '已中断',
...
export const en = {
  ...
  'activity.label': 'Execution activity',
  ...
  'approval.allowForTask': 'Allow for this task',
  'approval.allowOnce': 'Allow once',
  'turnSummary.label': 'This task used',
