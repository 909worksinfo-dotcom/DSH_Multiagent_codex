...
export class FakeApiClient implements IApiClient {
  ...
  onCollaborationConfirm: (payload: Parameters<IApiClient['collaboration']['confirm']>[0]) =>
  Promise<RpcResponse<CollaborationRunView>> = () => Promise.reject(new Error('collaboration.confirm is not programmed'))
  ...
  readonly collaboration: IApiClient['collaboration'] = {
    ...
    confirm: payload => this.record('collaboration.confirm', payload, this.onCollaborationConfirm(payload)),
