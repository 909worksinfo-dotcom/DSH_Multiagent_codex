...
describe('gen-tool-catalog collectToolCatalog', () => {
  it('boots every shipped tool package and harvests its model-facing schemas', async () => {
    ...
    expect(names).toEqual([
      'ask_user_question', 'bash', 'bash', 'collaboration_get', 'collaboration_send',
      'collaboration_task_create', 'collaboration_task_get', 'collaboration_task_list',
      'collaboration_task_update', 'cordis_define', 'cordis_inspect_list',
