...
export const muxFrameSchema = z.discriminatedUnion('type', [
  ...
  z.object({
    ...
    collaborationRunId: sessionIdSchema.optional(),
  }),
  z.object({ type: z.literal('approval/resolved'), sessionId: sessionIdSchema, approvalId: approvalRequestIdSchema, outcome: z.union([z.literal('allowed-once'), z.literal('allowed-for-turn'), z.literal('rejected'), z.literal('cancelled'), z.literal('unavailable')]) }),
