...
export const collaborationRunValueSchema = z.object({
  ...
  lead: z.object({ sessionId: nonBlank, name: z.literal('lead'), role: z.literal('Lead Agent') }),
...
export const collaborationListRequestSchema = z.object({}) as unknown as z.ZodType<Wire<RequestPayload<'collaboration.list'>>>
