...
import {
  ...
  collaborationConfirmRequestSchema,
...
const UNARY_ROUTES: UnaryRoutes = {
  ...
  'collaboration.confirm': { schema: collaborationConfirmRequestSchema, invoke: (api, r, signal) => api.collaboration.confirm(r, signal) },
