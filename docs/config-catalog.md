...
Source: [`packages/collaboration/agent-team/src/types.ts:150`](../packages/collaboration/agent-team/src/types.ts)
...
Source: [`packages/collaboration/expert-catalog/src/types.ts:100`](../packages/collaboration/expert-catalog/src/types.ts)

<a id="deepseek-aidsh-expert-runtime"></a>

## `@deepseek-ai/dsh-expert-runtime`

Requires: `agents` · `sessions` · `sessionPersistence` · `teamRuns` · `expertCatalog` · `subagents`
...
Source: [`packages/collaboration/expert-runtime/src/types.ts:30`](../packages/collaboration/expert-runtime/src/types.ts)
...
Requires: `agents` · `sessions` · `teamRuns` · `expertCatalog` · `expertRuntime`
...
Depends on: [`ExpertBlueprintRef`](subsystems/agent-team.md) · [`TeamRunComplexity`](../packages/collaboration/agent-team/src/index.ts)

Source: [`packages/collaboration/team-orchestrator/src/types.ts:98`](../packages/collaboration/team-orchestrator/src/types.ts)
...
Requires: `agents` · `expertRuntime` · `teamRuns` · `tools` · `systemPrompt`
...
Source: [`packages/collaboration/tool-agent-team/src/index.ts:49`](../packages/collaboration/tool-agent-team/src/index.ts)
