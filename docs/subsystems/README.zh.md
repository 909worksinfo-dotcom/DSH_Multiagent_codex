...
| [agent-team.md](agent-team.md) | 稳定 TeamRun 协作：隐式 Lead 身份、精确专家组队与补偿、公开类型化记录和 compare-and-set 任务 DAG，P2 ExpertBlueprint 绑定由 collaboration catalog/runtime 包提供 |
