...
| [agent-team.md](agent-team.md) | Stable TeamRun collaboration: implicit Lead identity, exact expert formation and compensation, public typed records, and a compare-and-set task DAG; P2 ExpertBlueprint binding is provided by the collaboration catalog/runtime packages |
